...
from prediction_help import predict  # Ensure this is correctly linked to your prediction_helper.py
...
if st.button('Calculate Risk'):
    ...
    delinquent_ratio = delinquent_ratio / 100
...
# Footer
st.markdown('_A project inspired by the Codebasics ML Course_')